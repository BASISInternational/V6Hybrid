...
rem --- agingVec! holds customer agings for each period
    ...
    while 1
        ...
        if arm02a.v6_firm_id$<>firm_id$ then break
    
        agingVec!=BBjAPI().makeVector()
        agingVec!.addItem(arm02a.v6_aging_future); rem --- 0=Future
        agingVec!.addItem(arm02a.v6_aging_cur); rem --- 1=Current
        agingVec!.addItem(arm02a.v6_aging_30); rem --- 2=30 Days
        agingVec!.addItem(arm02a.v6_aging_60); rem --- 3=60 Days
        agingVec!.addItem(arm02a.v6_aging_90); rem --- 4=90 Days
        agingVec!.addItem(arm02a.v6_aging_120); rem --- 5=120 Days
        ...
        customerMap!.put(arm02a.v6_customer_nbr$,agingVec!)
        agingMap!.put(agingVec!.getItem(period),customerMap!)
    wend

rem --- Build result set for top five
